...
import AIR from "@/img/ai.gif"

export function Package2Icon(props: any) {
  return (
    <Image {...props} height={44} width={44} src={icon} alt="icon" />
  )
}

export function AIRobot(props: any){
  return (
    <>
    <Image {...props} height={44} width={44} src={AIR} alt="icon" />
    </>
  )
}
